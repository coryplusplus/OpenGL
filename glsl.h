...
//#include <cwc/setup.h>
//#include "wglew.h"  // include glew if you don't use cwc/setup.h
#include "glew.h"  // include glew if you don't use cwc/setup.h
...
public:
   ...
   bool oglslEnabled(void);                       //!< returns true if GLSL is available.
...
//-----------------------------------------------------------------------------
// Classless functions to initialize OpenGL Extensions and check for GLSL and 
// OpenGL2
